...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	channelMonitorCooldownStore := repository.NewChannelMonitorCooldownStore(redisClient)
	channelMonitorRequestLedgerStore := repository.NewChannelMonitorRequestLedgerStore(redisClient)
	channelMonitorPriority := service.NewChannelMonitorPriorityAdjuster(accountRepository, schedulerCache)
	channelMonitorObserver := service.NewChannelMonitorProbeObserver(channelMonitorCooldownStore, channelMonitorPriority, settingService.ChannelMonitorCooldownSettingsProvider)
	channelMonitorObserver.SetRequestLedger(channelMonitorRequestLedgerStore)
	...
	gatewayService.SetChannelMonitorCooldownStore(channelMonitorCooldownStore)
	gatewayService.SetChannelMonitorProbeObserver(channelMonitorObserver)
	...
	openAIGatewayService.SetChannelMonitorCooldownStore(channelMonitorCooldownStore)
	openAIGatewayService.SetChannelMonitorProbeObserver(channelMonitorObserver)
	...
	channelMonitorService.SetProbeObserver(channelMonitorObserver)
	...
	accountHandler.SetChannelMonitorCooldownStore(channelMonitorCooldownStore)
