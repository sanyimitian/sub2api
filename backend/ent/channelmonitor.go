...
type ChannelMonitor struct {
	...
	// Whether probes target the current service and carry the internal monitor marker
	UseCurrentService bool `json:"use_current_service,omitempty"`
...
func (*ChannelMonitor) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case channelmonitor.FieldExtraModels, channelmonitor.FieldExtraHeaders, channelmonitor.FieldBodyOverride:
			values[i] = new([]byte)
		case channelmonitor.FieldEnabled, channelmonitor.FieldUseCurrentService:
...
func (_m *ChannelMonitor) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case channelmonitor.FieldUseCurrentService:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field use_current_service", values[i])
			} else if value.Valid {
				_m.UseCurrentService = value.Bool
			}
...
func (_m *ChannelMonitor) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("use_current_service=")
	builder.WriteString(fmt.Sprintf("%v", _m.UseCurrentService))
	builder.WriteString(", ")
