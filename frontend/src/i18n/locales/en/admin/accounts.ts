export default {
    accounts: {
      ...
      columns: {
        ...
        notes: 'Notes',
        priority: 'Priority',
        basePriorityColumn: 'Base Priority',
        effectivePriority: 'Effective Priority',
        temporaryPriority: 'Temporary priority from slow response',
        temporaryPriorityShort: 'Temp',
        noTemporaryPriority: 'None',
        temporaryPriorityRemaining: 'Resets in {remaining}',
        temporaryPriorityReset: 'Temporary Priority Reset',
        temporaryPriorityResetting: 'Resetting soon',
        basePriority: 'Base priority: {value}',
