export default {
    settings: {
      ...
      site: {
        ...
        docUrlHint: 'Link to your documentation site. Leave empty to use the built-in user guide.',
        siteLogo: 'Site Logo',
      ...
      payment: {
        ...
        redeemPurchaseEnabled: 'Enable payment redirect',
        redeemPurchaseEnabledHint: 'Show an entry for buying redeem codes on the redemption page.',
        redeemPurchaseUrl: 'Redeem code purchase URL',
        redeemPurchaseUrlPlaceholder: 'https://example.com/buy-redeem-code',
        redeemPurchaseUrlHint: 'Must be an absolute http(s) URL. Users will open it from the redemption page.',
        recommendedRedeemPurchaseUrl: 'Low-fee redeem code purchase URL',
        recommendedRedeemPurchaseUrlPlaceholder: 'https://example.com/recommended-redeem-code',
        recommendedRedeemPurchaseUrlHint: 'Must be an absolute http(s) URL. It appears first as the recommended entry on the redemption page.',
