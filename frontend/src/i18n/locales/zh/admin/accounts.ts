export default {
    accounts: {
      ...
      columns: {
        ...
        notes: '备注',
        priority: '优先级',
        basePriorityColumn: '基础优先级',
        effectivePriority: '有效优先级',
        temporaryPriority: '慢响应临时优先级',
        temporaryPriorityShort: '临时',
        noTemporaryPriority: '无',
        temporaryPriorityRemaining: '重置倒计时：{remaining}',
        temporaryPriorityReset: '临时优先级重置',
        temporaryPriorityResetting: '即将重置',
        basePriority: '基础优先级：{value}',
